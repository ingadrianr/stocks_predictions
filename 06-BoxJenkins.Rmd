...
```{r 06-3, warning=FALSE, message=FALSE,echo=FALSE}
...
```{r 06-4, warning=FALSE, message=FALSE,echo=FALSE}
...
```{r 06-5, warning=FALSE, message=FALSE,echo=FALSE}
...
```{r 06-6, warning=FALSE, message=FALSE,echo=FALSE}
library(changepoint)
